<?php 
  ...
  $biglist = !empty($picArr['big']) ? $picArr['big'] : array(array('url'=>$row['litpic']));//大图
  $GLOBALS['thumblist'] =!empty($picArr['thumb']) ? $picArr['thumb'] : array(array('url'=>$row['litpic']));//大图 $picArr['thumb'];//小图
  //特色服务项目
