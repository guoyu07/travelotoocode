...
<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no">
    ...
    {php echo Common::js('jquery.min.js,amazeui.js,common.js,jquery.validate.min.js');}
    <script>
    var SITEURL = "{$cmsurl}";
</script>
</head>
...
<body>
  ...
  <section>
  	...
  	<div class="mid_content">
        <form action="{$cmsurl}member/linkman/update?action=save" method="post" id="form">
  ...
  <div class="bom_link_box">
  	<div class="bom_fixed">
        {if !isset($info['isadd'])}
    	<a href="{$cmsurl}member/linkman/update?action=delete&id={$info['id']}">删除联系人</a>
        {/if}
